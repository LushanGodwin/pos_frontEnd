...
function generateOrderId(){
    oder_api.generateOderID().then((OderId) =>{
        oder_id.val(JSON.parse(OderId));
    }).catch((error)=>{
...
/*function generateOrderId(){
    ...
    if (CustomerAPI.length > 0){
        let lastElement = OrderAPI[OrderAPI.length - 1].orderId;
